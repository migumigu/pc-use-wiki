---
report_id: 2026-06-28-hardware-input-v1
title: 硬件输入设备控制技术分析报告 v1.0
version: 1.0
...
- **跨平台支持**：Linux、macOS、Windows、Android、WebAssembly
...
- inputs 在 macOS 上的实际性能
- libusb 与 Python 的集成方案（PyUSB vs python-libusb1）
- 在 Agent 环境中的权限管理方案
