---
report_id: auto-2026-06-29-goose-report-v1.1
title: Goose AI Agent 技术分析报告 v1.1
version: 1.1
...
Goose 是由 Linux Foundation 旗下 Agentic AI Foundation (AAIF) 孵化的开源本地 AI Agent 项目，当前 GitHub Stars **49.7K+**，贡献者 500+。项目使用 Rust 构建，提供 macOS/Linux/Windows 桌面应用、CLI 和嵌入式 API 三种交互形态。作为通用 AI Agent，Goose 不仅限于代码任务，还支持研究、写作、自动化和数据分析等工作流。

**核心价值定位**：通过 MCP (Model Context Protocol) 生态连接扩展，支持 15+ LLM Provider (Anthropic/OpenAI/Google/Ollama 等)<!-- confidence: UNVERIFIED — 以官方最新数据为准 -->，Goose 构建了一个开放、可扩展的本地 AI Agent 运行时，填补了"需要访问本机上下文和敏感项目的本地 Agent"空白。
...
**协议/接口层**：
- MCP (Model Context Protocol) — 扩展连接 <!-- confidence: UNVERIFIED — 数量以官方扩展市场为准 -->
...
- 15+ LLM Provider 适配 <!-- confidence: UNVERIFIED — 以官方 Provider 文档为准 -->
...
| **多 Provider** | 15+ 云端/本地 Provider <!-- confidence: UNVERIFIED --> | EXTRACTED (GitHub README) |
| | ACP 订阅接入 | EXTRACTED (官方文档) |
| **MCP 扩展** | 扩展连接 <!-- confidence: UNVERIFIED --> | EXTRACTED (GitHub README) |
...
- 自动更新下载可配置选项
- 其他已记录的 Issue (161 open issues on GitHub)
...
|------|----------|----------|----------|----------|-------------|
| **Goose** | AAIF/Linux Foundation | 本地 | Desktop+CLI+API | 支持 | 15+ <!-- confidence: UNVERIFIED --> |
...
2. **MCP 生态深度** — Model Context Protocol 开放标准
...
| 来源 | 类型 | 置信度 | 主要贡献 |
|------|------|--------|----------|
| [[auto-2026-06-29-goose-github-readme]] | Tier 1 | EXTRACTED | 核心数据 (49.7K Stars, 15+ Provider, MCP) |
...
| 问题 | 优先级 | 验证方式 |
|------|--------|----------|
| "15+ Provider" 具体列表和覆盖模型 | P2 | 官方 Provider 文档 |
| MCP 扩展具体数量和列表 | P2 | 官方 MCP Servers 仓库 |
...
| v1.1 | 2026-06-29 | 证伪修正：Stars 数量更新至 49.7K+，Provider/MCP 数量标注 UNVERIFIED |