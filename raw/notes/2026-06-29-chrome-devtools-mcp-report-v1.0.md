---
report_id: 2026-06-29-chrome-devtools-mcp-v1.0
title: chrome-devtools-mcp 技术分析报告 v1.0
version: 1.0
...
# chrome-devtools-mcp 技术分析报告 v1.0
...
**chrome-devtools-mcp** 是 Google Chrome DevTools 团队于 2025 年 9 月发布的官方 MCP (Model Context Protocol) 服务器，将 Chrome DevTools 的全部能力以 44 个 MCP 工具的形式暴露给 AI 编码助手。与传统浏览器自动化工具（如 Selenium、Puppeteer）不同，它的核心设计目标是让 Agent 自己决定要做什么，而非执行预定义脚本。

**为什么重要**：
- 解决了 AI Agent 无法直接访问和理解浏览器状态的"最后一公里"问题
- 8 个月内获得 38,866 Stars，表明社区强烈需求
...
| 能力 | 说明 | 证据来源 |
|------|------|----------|
| 浏览器控制 | 导航、点击、输入、截图 | 官方文档 |
| DOM 操作 | 完整 DOM 快照、选择器查询、JS 执行 | 官方文档 |
| 网络监控 | 请求/响应监听、数据获取 | 官方文档 |
| 性能分析 | 指标收集、性能分析 | 官方文档 |
| 登录态保持 | 支持指定 Chrome Data 目录 | 技术博客 |
| 多浏览器 | Chrome 及 Chromium 衍生浏览器 | 官方文档 |

### 3.2 局限性

| 局限性 | 说明 | 来源 |
|--------|------|------|
| 仅支持 Chrome/Chromium | 不支持 Firefox、Safari | 官方文档 |
| Headless 默认 | 默认无头模式，需配置才能显示 UI | 技术博客 |
| 登录态限制 | 默认看不到已登录账号，需指定 Data 目录 | 技术博客 |
| 无插件支持 | 不支持浏览器扩展 | 技术博客 |
...
| 工具 | 发布时间 | Stars | 目标用户 | 核心优势 |
|------|----------|-------|----------|----------|
| **chrome-devtools-mcp** | 2025-09 | 38,866+ | AI Agent | 官方支持、MCP 协议 |
| **browser-use** | 2026-01 | 17,000+ | AI Agent | 视觉模型驱动 |
| **agent-browser** | 2026-01 | 37,000+ | AI Agent | Vercel 官方、CLI 工具 |
| **Selenium** | 2004 | 28,000+ | 测试工程师 | 生态成熟 |
| **Puppeteer** | 2017 | 85,000+ | 开发者 | Chrome 官方 |
| **Playwright** | 2020 | 65,000+ | 测试工程师 | 跨浏览器 |
