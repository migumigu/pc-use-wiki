---
report_id: auto-2026-06-28-cua-report-v1.1
title: CUA 技术分析报告
version: v1.1
...
### 3.3 已知问题（GitHub Issues 验证）

| 问题 | 来源 | 说明 |
|------|------|------|
| Windows UIA 限制 | Issue #1616 | Chromium/Electron content tree 对 UIA 不可见 |
| macOS M4 问题 | Issue #1671 | Swift continuation leak，Hermes Agent 超时 |
| 截图分辨率 | Issue #1592 | 原生分辨率图片与点击坐标系统不一致 |
| 键盘布局依赖 | Issue #1605 | 非拉丁键盘布局下按键输入问题 |
| macOS 26 挂起 | Issue #1537 | get_window_state 在 macOS 26 上挂起 |
| Lume SSH 损坏 | Issue #1513 | 二进制 stdout UTF-8 强制转换导致损坏 |
...
- 需要本地 GUI 直接操作（非沙箱）
- 资源受限环境
- Electron/Chromium 应用（Windows UIA 限制）
...
| v1.1 | 2026-06-28 | 证伪修正：添加 Windows UIA 限制、macOS 问题、截图分辨率问题等已知问题 |
