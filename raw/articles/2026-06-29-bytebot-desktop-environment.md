---
source_id: auto-20260629-bytebot-desktop
title: Bytebot Desktop Environment - Virtual Linux Desktop Documentation
url: https://docs.bytebot.ai/core-concepts/desktop-environment
...
The core container also exposes an MCP (Model Context Protocol) endpoint. Connect your MCP client to `http://localhost:9990/mcp` to invoke these tools over SSE.
