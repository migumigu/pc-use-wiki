---
source_id: auto-20260701-driver01
title: Cua Driver Technical Documentation - Background Computer-Use Driver
...
confidence: high
source_url: https://cua.ai/docs/cua-driver/guide/getting-started/introduction
---
...
Cua Driver is open-source and MIT licensed. If you find it useful, we'd appreciate a [star on GitHub](https://github.com/trycua/cua)!
...
- macOS off-Space SwiftUI windows can strip their accessibility tree by OS design.
...
Ready to try it? [Install Cua Driver](https://cua.ai/docs/cua-driver/guide/getting-started/installation) and drive your first app in the [Quickstart](https://cua.ai/docs/cua-driver/guide/getting-started/quickstart).