...
title: Anthropic Computer Use Demo - GitHub Official Repository
...
- **来源层级**: Tier 1 - Anthropic官方GitHub仓库
- **技术架构**: Docker容器化 + X11 + VNC，agent loop在容器内运行
- **支持模型**: Claude Opus 4.8, 4.7, 4.6, Sonnet 4.6, 4.5, Haiku 4.5等
- **核心组件**: Anthropic定义的computer use工具 + Streamlit交互界面
- **安全风险**: Beta功能，存在prompt injection风险，需要VM隔离和权限控制
- **推荐分辨率**: XGA (1024x768)，避免超过API限制导致自动缩放影响精度
- **提供商支持**: Claude API、AWS Bedrock、Google Vertex