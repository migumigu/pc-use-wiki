...
### 长时记忆系统（2026-07-02新增）
- [[Mem0]] — 通用 AI Agent 记忆层，事实提取范式，41K-60K+ Stars，生产就绪度最高
- [[Memora]] — 微软 ICML 2026 Agent 长期记忆系统，Harmonic Memory 三重索引，上下文减少 98%
- [[Eigent]] — 全球首个多智能体工作流桌面应用，5K-10K Stars，MCP 集成记忆系统
...
- [[Atlas]] — Elastic 开源 Agent 记忆系统，基于认知科学三重索引（Episodic/Semantic/Procedural），MCP 集成，Recall@10=0.89（2026-07-02新增）

### 安全测试/渗透测试（2026-07-02新增）
- [[VulnClaw]] — AI 驱动的渗透测试 CLI 工具，说人话打漏洞，1.5K+ Stars，21+ 渗透 Skill
...
- [[Qoder]] — 阿里巴巴 Agentic Platform，集成 Computer Use + Browser Use，后台桌面控制（2026-07-02新增）
- [[Kun]] — DeepSeek-GUI 本地 Agent 运行时，Cache-first agent loop，90%+ 缓存命中率（2026-07-02新增）
- [[OpenHands]] — 75.9K Stars 全栈 AI Coding Agent 平台，SWEBench 77.6% SOTA，五层架构 + 三层 Harness（2026-07-02新增）
- [[EventStream]] — OpenHands 事件流消息总线（2026-07-02新增）

### Agent Skills 系统（2026-07-02新增）
- [[agency-agents]] — 122K+ Stars AI Agent 人格集合库，16 Division 架构，51+ 专业化 Agent

### Agent 编排平台（2026-07-02新增）
- [[Orca]] — 7K+ Stars AI Agent 编排器，并行多 Agent 工作树架构，跨厂商中立

### 知识图谱记忆系统（2026-07-02新增）
- [[Cognee]] — 24K+ Stars 开源知识引擎，三层存储架构，MCP 集成
...
### Mem0 长时记忆系列（2篇，2026-07-02新增）
| 素材 | 核心内容 |
|------|----------|
| [[2026-07-02-mem0-github-readme]] | 事实提取范式、新算法改进、三级记忆层级 |
| [[2026-07-02-mem0-technical-analysis]] | 范式演进、与 Memora 对比、Mem0g 图增强 |

### Memora 长时记忆系列（2篇，2026-07-02新增）
| 素材 | 核心内容 |
|------|----------|
| [[2026-07-02-memora-icml2026]] | ICML 2026、三重索引、MDP 策略检索、基准 SOTA |
| [[2026-07-02-memora-technical-deep-dive]] | Harmonic Memory 设计、消融实验、企业部署 |

### Eigent 多Agent桌面系列（2篇，2026-07-02新增）
| 素材 | 核心内容 |
|------|----------|
...
### Agent 记忆技术报告系列（2篇，2026-07-02新增）
| 素材 | 核心内容 |
|------|----------|
| [[2026-07-02-agent-memory-technical-report]] | 三大范式对比、六层技术栈、能力矩阵 |
| [[2026-07-02-falsification-record]] | 13 项声明验证、Stars 修正、论文数据待独立验证 |
...
- [[Mem0]]（实体页,2026-07-02新增）
- [[Memora]]（实体页,2026-07-02新增）
- [[Eigent]]（实体页,2026-07-02新增）
- [[CUA]]（实体页,已更新）
